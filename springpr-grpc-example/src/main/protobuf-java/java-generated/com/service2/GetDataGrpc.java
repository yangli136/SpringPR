...
@javax.annotation.Generated(
    ...
    comments = "Source: proto/service/service2.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class GetDataGrpc {

  private GetDataGrpc() {}

  public static final java.lang.String SERVICE_NAME = "service2.GetData";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.service2.GetDataRequest,
      com.service2.GetDataResponse> getGetDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetData",
      requestType = com.service2.GetDataRequest.class,
      responseType = com.service2.GetDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.service2.GetDataRequest,
      com.service2.GetDataResponse> getGetDataMethod() {
    io.grpc.MethodDescriptor<com.service2.GetDataRequest, com.service2.GetDataResponse> getGetDataMethod;
      ...
      synchronized (GetDataGrpc.class) {
        if ((getGetDataMethod = GetDataGrpc.getGetDataMethod) == null) {
          GetDataGrpc.getGetDataMethod = getGetDataMethod =
              io.grpc.MethodDescriptor.<com.service2.GetDataRequest, com.service2.GetDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.service2.GetDataRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.service2.GetDataResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getData(com.service2.GetDataRequest request,
        io.grpc.stub.StreamObserver<com.service2.GetDataResponse> responseObserver) {
  ...
  public static final class GetDataStub
    ...
    /**
     */
    public void getData(com.service2.GetDataRequest request,
        io.grpc.stub.StreamObserver<com.service2.GetDataResponse> responseObserver) {
  ...
  public static final class GetDataBlockingV2Stub
    ...
    /**
     */
    public com.service2.GetDataResponse getData(com.service2.GetDataRequest request) {
  ...
  public static final class GetDataFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.service2.GetDataResponse> getData(
        com.service2.GetDataRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DATA:
          serviceImpl.getData((com.service2.GetDataRequest) request,
              (io.grpc.stub.StreamObserver<com.service2.GetDataResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.service2.GetDataRequest,
              com.service2.GetDataResponse>(
