...
[Clone this repository locally](), create a branch named `feature/<feature_name>`, open a PR to `main`, and follow the guidelines outlined in this document.
...
- Write tests for your changes. A feature is not considered done until it has tests and/or a test plan. It does not matter if code coverage shows 100%, tests are expected for _all_ changes.
