...
public class ApplicationMDCAspect {
    ...
    @Pointcut(
            "execution(* *(..)) &&"
                    + " @annotation(org.springpr.springpr.base.logging.Log4jDiagnosticContextEnable)")
    public void log4jDiagnosticContextEnabled() {
        // do nothing.
    }

    @Before("org.springpr.springpr.base.logging.ApplicationMDCAspect.log4jDiagnosticContextEnabled()")
