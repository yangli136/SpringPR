...
```
http://localhost:38866/springpr-base/welcome
```
...
#### deploy application to ePaaS by following SpringPR eCP enterprise XLR

```
    stage("ePaaS XLR release") {
        releasePipeline {
            project        = 'casm-kafka-perf-runner'
            service        = 'casmkafkaperf6'
            template_name   = 'jar-app-template'
            central_id     = '600001143'
            templateAlias  = 'casm-kafka-perf-runner_casmkafkaperf6'
            subscriptionID = 'cd-api-subid-125a90ed-7d26-44ce-b428-5895f6294547'
        }
    }
```
