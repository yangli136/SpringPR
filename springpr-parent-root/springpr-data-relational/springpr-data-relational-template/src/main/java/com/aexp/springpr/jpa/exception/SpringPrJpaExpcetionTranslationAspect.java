/* (C)2023 */
package com.aexp.springpr.jpa.exception;
...
public class SpringPrJpaExpcetionTranslationAspect {
    @Pointcut("@within(com.aexp.springpr.jpa.stereotype.SpringPrJpaService)")
    public void anyJpaServiceMethod() {}

    @Before(
            "com.aexp.springpr.jpa.exception.SpringPrJpaExpcetionTranslationAspect.anyJpaServiceMethod()")
